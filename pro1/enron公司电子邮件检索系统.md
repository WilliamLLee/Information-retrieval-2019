...
![用户列表目录](./figures/用户列表目录.JPG)

![用户邮件分类列表](./figures/用户邮件分类列表.JPG)
...
```
- 文件向量空间长度信息：
![文件向量空间长度信息](./figures//词汇信息.JPG)

- 文件索引列表信息
![文件索引信息](./figures//词汇列表.JPG)
## 三 检索系统构建
...
![前端界面](./figures//检索界面.JPG)

- 查询显示文本

![显示文本](./figures//显示文本.JPG)
